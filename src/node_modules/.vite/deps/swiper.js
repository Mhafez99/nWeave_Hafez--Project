...
var require_swiper = __commonJS({
  "node_modules/swiper/dist/js/swiper.js"(exports, module) {
    (function() {
      "use strict";
      var $;
      var Swiper = function(container, params) {
        ...
        s.setBreakpoint = function() {
          ...
          if (breakpoint && s.currentBreakpoint !== breakpoint) {
            ...
            for (var param2 in breakPointsParams) {
              s.params[param2] = breakPointsParams[param2];
            }
        ...
        s.preloadImages = function() {
          ...
          for (var i2 = 0; i2 < s.imagesToLoad.length; i2++) {
            s.loadImage(s.imagesToLoad[i2], s.imagesToLoad[i2].currentSrc || s.imagesToLoad[i2].getAttribute("src"), s.imagesToLoad[i2].srcset || s.imagesToLoad[i2].getAttribute("srcset"), s.imagesToLoad[i2].sizes || s.imagesToLoad[i2].getAttribute("sizes"), true, _onReady);
          }
        };
        ...
        s.updateAutoHeight = function() {
          ...
          if (s.params.slidesPerView !== "auto" && s.params.slidesPerView > 1) {
            for (i2 = 0; i2 < Math.ceil(s.params.slidesPerView); i2++) {
              var index = s.activeIndex + i2;
          ...
          for (i2 = 0; i2 < activeSlides.length; i2++) {
        ...
        s.updateSlidesSize = function() {
          ...
          s.slidesGrid = [];
          s.slidesSizesGrid = [];
          var spaceBetween = s.params.spaceBetween, slidePosition = -s.params.slidesOffsetBefore, i2, prevSlideSize = 0, index = 0;
          ...
          for (i2 = 0; i2 < s.slides.length; i2++) {
            slideSize = 0;
            var slide = s.slides.eq(i2);
            if (s.params.slidesPerColumn > 1) {
            ...
            if (s.params.slidesPerView === "auto") {
              ...
              if (s.params.roundLengths)
                slideSize = round(slideSize);
              if (s.isHorizontal()) {
                s.slides[i2].style.width = slideSize + "px";
              } else {
                s.slides[i2].style.height = slideSize + "px";
              }
            }
            s.slides[i2].swiperSlideSize = slideSize;
          ...
          if (s.params.slidesPerColumn > 1) {
            ...
            if (s.params.centeredSlides) {
              newSlidesGrid = [];
              for (i2 = 0; i2 < s.snapGrid.length; i2++) {
                if (s.snapGrid[i2] < s.virtualSize + s.snapGrid[0])
                  newSlidesGrid.push(s.snapGrid[i2]);
              }
          ...
          if (!s.params.centeredSlides) {
            newSlidesGrid = [];
            for (i2 = 0; i2 < s.snapGrid.length; i2++) {
              if (s.snapGrid[i2] <= s.virtualSize - s.size) {
                newSlidesGrid.push(s.snapGrid[i2]);
              }
            }
            s.snapGrid = newSlidesGrid;
        ...
        s.updateSlidesOffset = function() {
          for (var i2 = 0; i2 < s.slides.length; i2++) {
            s.slides[i2].swiperSlideOffset = s.isHorizontal() ? s.slides[i2].offsetLeft : s.slides[i2].offsetTop;
          }
        };
        s.currentSlidesPerView = function() {
          ...
          if (s.params.centeredSlides) {
            ...
            var breakLoop;
            for (i2 = s.activeIndex + 1; i2 < s.slides.length; i2++) {
              if (s.slides[i2] && !breakLoop) {
                size += s.slides[i2].swiperSlideSize;
                spv++;
                if (size > s.size)
                  breakLoop = true;
              }
            ...
            for (i2 = s.activeIndex + 1; i2 < s.slides.length; i2++) {
              if (s.slidesGrid[i2] - s.slidesGrid[s.activeIndex] < s.size) {
                spv++;
              }
            }
          }
        ...
        s.updateSlidesProgress = function(translate) {
          ...
          for (var i2 = 0; i2 < s.slides.length; i2++) {
            var slide = s.slides[i2];
            var slideProgress = (offsetCenter + (s.params.centeredSlides ? s.minTranslate() : 0) - slide.swiperSlideOffset) / (slide.swiperSlideSize + s.params.spaceBetween);
            if (s.params.watchSlidesVisibility) {
              var slideBefore = -(offsetCenter - slide.swiperSlideOffset);
              var slideAfter = slideBefore + s.slidesSizesGrid[i2];
              var isVisible = slideBefore >= 0 && slideBefore < s.size || slideAfter > 0 && slideAfter <= s.size || slideBefore <= 0 && slideAfter >= s.size;
              if (isVisible) {
                s.slides.eq(i2).addClass(s.params.slideVisibleClass);
              }
            }
        ...
        s.updateActiveIndex = function() {
          ...
          var newActiveIndex, i2, snapIndex;
          for (i2 = 0; i2 < s.slidesGrid.length; i2++) {
            if (typeof s.slidesGrid[i2 + 1] !== "undefined") {
              if (translate >= s.slidesGrid[i2] && translate < s.slidesGrid[i2 + 1] - (s.slidesGrid[i2 + 1] - s.slidesGrid[i2]) / 2) {
                newActiveIndex = i2;
              } else if (translate >= s.slidesGrid[i2] && translate < s.slidesGrid[i2 + 1]) {
                newActiveIndex = i2 + 1;
              }
            } else {
              if (translate >= s.slidesGrid[i2]) {
                newActiveIndex = i2;
              }
            }
          }
        ...
        s.updatePagination = function() {
          ...
          if (s.paginationContainer && s.paginationContainer.length > 0) {
            ...
            if (s.params.paginationType === "bullets") {
              ...
              for (var i2 = 0; i2 < numberOfBullets; i2++) {
                if (s.params.paginationBulletRender) {
                  paginationHTML += s.params.paginationBulletRender(s, i2, s.params.bulletClass);
                } else {
        ...
        s.onTouchEnd = function(e) {
          ...
          var i2, stopIndex = 0, groupSize = s.slidesSizesGrid[0];
          for (i2 = 0; i2 < s.slidesGrid.length; i2 += s.params.slidesPerGroup) {
            if (typeof s.slidesGrid[i2 + s.params.slidesPerGroup] !== "undefined") {
              if (currentPos >= s.slidesGrid[i2] && currentPos < s.slidesGrid[i2 + s.params.slidesPerGroup]) {
                stopIndex = i2;
                groupSize = s.slidesGrid[i2 + s.params.slidesPerGroup] - s.slidesGrid[i2];
              }
            } else {
              if (currentPos >= s.slidesGrid[i2]) {
                stopIndex = i2;
        ...
        s.slideTo = function(slideIndex, speed, runCallbacks, internal) {
          ...
          if (s.params.normalizeSlideIndex) {
            for (var i2 = 0; i2 < s.slidesGrid.length; i2++) {
              if (-Math.floor(translate * 100) >= Math.floor(s.slidesGrid[i2] * 100)) {
                slideIndex = i2;
              }
            }
          }
        ...
        s.initObservers = function() {
          if (s.params.observeParents) {
            ...
            for (var i2 = 0; i2 < containerParents.length; i2++) {
              initObserver(containerParents[i2]);
            }
          }
        ...
        s.disconnectObservers = function() {
          for (var i2 = 0; i2 < s.observers.length; i2++) {
            s.observers[i2].disconnect();
          }
          s.observers = [];
        };
        s.createLoop = function() {
          ...
          var prependSlides = [], appendSlides = [], i2;
          ...
          for (i2 = 0; i2 < appendSlides.length; i2++) {
            s.wrapper.append($(appendSlides[i2].cloneNode(true)).addClass(s.params.slideDuplicateClass));
          }
          for (i2 = prependSlides.length - 1; i2 >= 0; i2--) {
            s.wrapper.prepend($(prependSlides[i2].cloneNode(true)).addClass(s.params.slideDuplicateClass));
          }
        };
        ...
        s.removeSlide = function(slidesIndexes) {
          ...
          if (typeof slidesIndexes === "object" && slidesIndexes.length) {
            for (var i2 = 0; i2 < slidesIndexes.length; i2++) {
        ...
        s.effects = {
            ...
            setTransition: function(duration) {
              ...
              if (s.params.virtualTranslate && duration !== 0) {
                ...
                s.slides.transitionEnd(function() {
                  ...
                  for (var i2 = 0; i2 < triggerEvents.length; i2++) {
                    s.wrapper.trigger(triggerEvents[i2]);
                  }
                });
              }
            }
          ...
          cube: {
            setTranslate: function() {
              ...
              for (var i2 = 0; i2 < s.slides.length; i2++) {
                var slide = s.slides.eq(i2);
                var slideAngle = i2 * 90;
                var round2 = Math.floor(slideAngle / 360);
                if (s.rtl) {
                ...
                if (i2 % 4 === 0) {
                  ...
                  tx = s.size + round2 * 4 * s.size;
                  tz = s.size;
                } else if ((i2 - 3) % 4 === 0) {
                  tx = -s.size;
                  tz = 3 * s.size + s.size * 4 * round2;
                }
                if (s.rtl) {
                  tx = -tx;
                }
                ...
                if (progress <= 1 && progress > -1) {
                  wrapperRotate = i2 * 90 + progress * 90;
                  if (s.rtl)
                    wrapperRotate = -i2 * 90 - progress * 90;
                }
          ...
          coverflow: {
            setTranslate: function() {
              ...
              for (var i2 = 0, length = s.slides.length; i2 < length; i2++) {
                var slide = s.slides.eq(i2);
                var slideSize = s.slidesSizesGrid[i2];
        ...
        s.lazy = {
          ...
          load: function() {
            ...
            if (s.params.watchSlidesVisibility) {
              ...
              if (slidesPerView > 1) {
                for (i2 = s.activeIndex; i2 < s.activeIndex + slidesPerView; i2++) {
                  if (s.slides[i2])
                    s.lazy.loadImageInSlide(i2);
                }
              } else {
            ...
            if (s.params.lazyLoadingInPrevNext) {
              if (slidesPerView > 1 || s.params.lazyLoadingInPrevNextAmount && s.params.lazyLoadingInPrevNextAmount > 1) {
                ...
                for (i2 = s.activeIndex + slidesPerView; i2 < maxIndex; i2++) {
                  if (s.slides[i2])
                    s.lazy.loadImageInSlide(i2);
                }
                for (i2 = minIndex; i2 < s.activeIndex; i2++) {
                  if (s.slides[i2])
                    s.lazy.loadImageInSlide(i2);
                }
              } else {
        ...
        s.controller = {
          ...
          setTranslate: function(translate, byController) {
            ...
            if (Array.isArray(controlled)) {
              for (var i2 = 0; i2 < controlled.length; i2++) {
                if (controlled[i2] !== byController && controlled[i2] instanceof Swiper) {
          ...
          setTransition: function(duration, byController) {
            ...
            if (Array.isArray(controlled)) {
              for (i2 = 0; i2 < controlled.length; i2++) {
                if (controlled[i2] !== byController && controlled[i2] instanceof Swiper) {
        ...
        function handleKeyboard(e) {
          ...
          if (kc === 37 || kc === 39 || kc === 38 || kc === 40) {
            ...
            for (var i2 = 0; i2 < swiperCoord.length; i2++) {
        ...
        function setParallaxTransform(el, progress) {
          ...
          var p2, pX, pY;
          var rtlFactor = s.rtl ? -1 : 1;
          p2 = el.attr("data-swiper-parallax") || "0";
        ...
        s.zoom = {
          ...
          onTouchStart: function(s2, e) {
            var z = s2.zoom;
            if (!z.gesture.image || z.gesture.image.length === 0)
              return;
            if (z.image.isTouched)
              return;
            if (s2.device.os === "android")
              e.preventDefault();
          ...
          onTransitionEnd: function(s2) {
            var z = s2.zoom;
            if (z.gesture.slide && s2.previousIndex !== s2.activeIndex) {
          ...
          // Toggle Zoom
          toggleZoom: function(s2, e) {
            var z = s2.zoom;
            if (!z.gesture.slide) {
              z.gesture.slide = s2.clickedSlide ? $(s2.clickedSlide) : s2.slides.eq(s2.activeIndex);
              z.gesture.image = z.gesture.slide.find("img, svg, canvas");
              z.gesture.imageWrap = z.gesture.image.parent("." + s2.params.zoomContainerClass);
            }
            if (!z.gesture.image || z.gesture.image.length === 0)
              return;
            ...
            if (z.scale && z.scale !== 1) {
              ...
              z.scale = z.currentScale = z.gesture.imageWrap.attr("data-swiper-zoom") || s2.params.zoomMax;
              if (e) {
        ...
        s.callPlugins = function(eventName) {
          for (var i2 = 0; i2 < s._plugins.length; i2++) {
            if (eventName in s._plugins[i2]) {
              s._plugins[i2][eventName](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
            }
          }
        };
        ...
        s.emit = function(eventName) {
          ...
          if (s.emitterEventListeners[eventName]) {
            for (i2 = 0; i2 < s.emitterEventListeners[eventName].length; i2++) {
              s.emitterEventListeners[eventName][i2](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
            }
          }
          if (s.callPlugins)
        ...
        s.off = function(eventName, handler) {
          ...
          if (!s.emitterEventListeners[eventName] || s.emitterEventListeners[eventName].length === 0)
            return;
          for (i2 = 0; i2 < s.emitterEventListeners[eventName].length; i2++) {
            if (s.emitterEventListeners[eventName][i2] === handler)
              s.emitterEventListeners[eventName].splice(i2, 1);
          }
          return s;
        };
      ...
      var Dom7 = function() {
        ...
        var $2 = function(selector, context) {
          var arr = [], i2 = 0;
          if (selector && !context) {
            if (selector instanceof Dom72) {
              return selector;
            }
          }
          if (selector) {
            if (typeof selector === "string") {
              ...
              if (html.indexOf("<") >= 0 && html.indexOf(">") >= 0) {
                ...
                for (i2 = 0; i2 < tempParent.childNodes.length; i2++) {
              ...
              for (i2 = 0; i2 < selector.length; i2++) {
                arr.push(selector[i2]);
              }
            }
          }
          return new Dom72(arr);
        };
        Dom72.prototype = {
          ...
          addClass: function(className) {
            ...
            for (var i2 = 0; i2 < classes.length; i2++) {
              for (var j = 0; j < this.length; j++) {
                this[j].classList.add(classes[i2]);
              }
            }
            return this;
          },
          removeClass: function(className) {
            ...
            for (var i2 = 0; i2 < classes.length; i2++) {
              for (var j = 0; j < this.length; j++) {
                this[j].classList.remove(classes[i2]);
              }
            }
            return this;
          },
          ...
          toggleClass: function(className) {
            ...
            for (var i2 = 0; i2 < classes.length; i2++) {
              for (var j = 0; j < this.length; j++) {
                this[j].classList.toggle(classes[i2]);
              }
            }
            return this;
          },
          ...
          on: function(eventName, targetSelector, listener, capture) {
            function handleLiveEvent(e) {
              ...
              if ($2(target).is(targetSelector))
                ...
                var parents = $2(target).parents();
                for (var k = 0; k < parents.length; k++) {
                  if ($2(parents[k]).is(targetSelector))
            ...
            for (i2 = 0; i2 < this.length; i2++) {
              if (typeof targetSelector === "function" || targetSelector === false) {
                ...
                for (j = 0; j < events.length; j++) {
                  this[i2].addEventListener(events[j], listener, capture);
                }
              } else {
                for (j = 0; j < events.length; j++) {
                  if (!this[i2].dom7LiveListeners)
                    this[i2].dom7LiveListeners = [];
                  this[i2].dom7LiveListeners.push({ listener, liveListener: handleLiveEvent });
                  this[i2].addEventListener(events[j], handleLiveEvent, capture);
                }
              }
            }
            return this;
            ...
            for (var i2 = 0; i2 < events.length; i2++) {
              for (var j = 0; j < this.length; j++) {
                if (typeof targetSelector === "function" || targetSelector === false) {
                  ...
                  this[j].removeEventListener(events[i2], listener, capture);
                } else {
                  if (this[j].dom7LiveListeners) {
                    for (var k = 0; k < this[j].dom7LiveListeners.length; k++) {
                      if (this[j].dom7LiveListeners[k].listener === listener) {
                        this[j].removeEventListener(events[i2], this[j].dom7LiveListeners[k].liveListener, capture);
                      }
                    }
                  }
                }
          ...
          trigger: function(eventName, eventData) {
            for (var i2 = 0; i2 < this.length; i2++) {
              ...
              this[i2].dispatchEvent(evt);
            }
            return this;
          },
          transitionEnd: function(callback) {
            var events = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], i2, j, dom = this;
            function fireCallBack(e) {
              if (e.target !== this)
                return;
              callback.call(this, e);
              for (i2 = 0; i2 < events.length; i2++) {
                dom.off(events[i2], fireCallBack);
              }
            }
            if (callback) {
              for (i2 = 0; i2 < events.length; i2++) {
                dom.on(events[i2], fireCallBack);
              }
            }
            return this;
          },
          ...
          each: function(callback) {
            for (var i2 = 0; i2 < this.length; i2++) {
              callback.call(this[i2], i2, this[i2]);
            }
            return this;
          },
          html: function(html) {
          ...
          is: function(selector) {
            ...
            if (typeof selector === "string") {
              ...
              if (el.matches)
                ...
                for (i2 = 0; i2 < compareWith.length; i2++) {
                  if (compareWith[i2] === this[0])
                    return true;
                }
                return false;
              }
              ...
              if (selector.nodeType || selector instanceof Dom72) {
          ...
          eq: function(index) {
            ...
            if (index < 0) {
              ...
              if (returnIndex < 0)
                ...
                return new Dom72([this[returnIndex]]);
            }
            return new Dom72([this[index]]);
          },
          append: function(newChild) {
            ...
            for (i2 = 0; i2 < this.length; i2++) {
              ...
              } else if (newChild instanceof Dom72) {
          ...
          insertBefore: function(selector) {
            var before = $2(selector);
            for (var i2 = 0; i2 < this.length; i2++) {
              if (before.length === 1) {
                before[0].parentNode.insertBefore(this[i2], before[0]);
              } else if (before.length > 1) {
                for (var j = 0; j < before.length; j++) {
                  before[j].parentNode.insertBefore(this[i2].cloneNode(true), before[j]);
                }
              }
            }
          },
          insertAfter: function(selector) {
            var after = $2(selector);
            for (var i2 = 0; i2 < this.length; i2++) {
              if (after.length === 1) {
                after[0].parentNode.insertBefore(this[i2], after[0].nextSibling);
              } else if (after.length > 1) {
                for (var j = 0; j < after.length; j++) {
                  after[j].parentNode.insertBefore(this[i2].cloneNode(true), after[j].nextSibling);
                }
              }
            }
          },
            ...
            if (this.length > 0) {
              if (selector) {
                if (this[0].nextElementSibling && $2(this[0].nextElementSibling).is(selector))
                  return new Dom72([this[0].nextElementSibling]);
                else
                  return new Dom72([]);
              } else {
          ...
          nextAll: function(selector) {
            ...
            while (el.nextElementSibling) {
              ...
              if (selector) {
                if ($2(next).is(selector))
                  nextEls.push(next);
              } else
                nextEls.push(next);
              el = next;
            }
            return new Dom72(nextEls);
          },
          prev: function(selector) {
            if (this.length > 0) {
              if (selector) {
                if (this[0].previousElementSibling && $2(this[0].previousElementSibling).is(selector))
                  return new Dom72([this[0].previousElementSibling]);
                else
                  return new Dom72([]);
              } else {
          ...
          prevAll: function(selector) {
            ...
            while (el.previousElementSibling) {
              ...
              if (selector) {
                if ($2(prev).is(selector))
                  prevEls.push(prev);
              } else
                prevEls.push(prev);
              el = prev;
            }
            return new Dom72(prevEls);
          },
            ...
            for (var i2 = 0; i2 < this.length; i2++) {
              if (selector) {
                if ($2(this[i2].parentNode).is(selector))
                  parents.push(this[i2].parentNode);
              } else {
                parents.push(this[i2].parentNode);
              }
            }
            return $2($2.unique(parents));
          },
          parents: function(selector) {
            var parents = [];
            for (var i2 = 0; i2 < this.length; i2++) {
              var parent = this[i2].parentNode;
              while (parent) {
                if (selector) {
                  if ($2(parent).is(selector))
                    parents.push(parent);
                } else {
                  parents.push(parent);
                }
          ...
          find: function(selector) {
            ...
            return new Dom72(foundElements);
          },
          children: function(selector) {
            var children = [];
            for (var i2 = 0; i2 < this.length; i2++) {
              var childNodes = this[i2].childNodes;
              for (var j = 0; j < childNodes.length; j++) {
                if (!selector) {
                  if (childNodes[j].nodeType === 1)
                    children.push(childNodes[j]);
                } else {
                  if (childNodes[j].nodeType === 1 && $2(childNodes[j]).is(selector))
                    children.push(childNodes[j]);
                }
              }
            }
            return new Dom72($2.unique(children));
          },
          remove: function() {
            for (var i2 = 0; i2 < this.length; i2++) {
        ...
        $2.fn = Dom72.prototype;
        $2.unique = function(arr) {
          var unique = [];
          for (var i2 = 0; i2 < arr.length; i2++) {
            if (unique.indexOf(arr[i2]) === -1)
              unique.push(arr[i2]);
          }
          return unique;
        };
